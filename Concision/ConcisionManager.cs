...
using Concision.Properties;

namespace Concision
{
    public class ConcisionManager
    {
        //Singleton instance
        private static ConcisionManager _instance;

        //Forms to control
        private readonly List<ConcisionForm> _formsToManage = new List<ConcisionForm>();
        ...
        private static readonly Color PRIMARY_TEXT_BLACK = Color.FromArgb(255, 0, 0, 0);
        ...
        public Font FontOfMedium12 { get; set; }
        public Font FontOfRegular11 { get; set; }
        public Font FontOfMedium11 { get; set; }
        public Font FontOfMedium10 { get; set; }
        ...
        private ConcisionManager()
        {

            this.FontOfMedium12 = new Font("微软雅黑", 12f);
            this.FontOfMedium10 = new Font("微软雅黑", 10f);
            this.FontOfRegular11 = new Font("微软雅黑", 11f);
            this.FontOfMedium11 = new Font("微软雅黑", 11f);
        ...
        public static ConcisionManager Instance => _instance ?? (_instance = new ConcisionManager());
        ...
        private void UpdateToolStrip(ToolStrip toolStrip, Color newBackColor)
        {
            ...
            foreach (ToolStripItem control in toolStrip.Items)
            {
                ...
                if (control is ConcisionToolStripMenuItem && (control as ConcisionToolStripMenuItem).HasDropDown)
                {

                    //recursive call
                    UpdateToolStrip((control as ConcisionToolStripMenuItem).DropDown, newBackColor);
                }
            }
        }
        ...
        private void UpdateControl(Control controlToUpdate, Color newBackColor)
        {
            ...
            var tabControl = controlToUpdate as ConcisionTabControl;
            if (tabControl != null)
            {
            ...
            if (controlToUpdate is ConcisionDivider)
            {
                controlToUpdate.BackColor = GetDividersColor();
            }

            if (controlToUpdate is ConcisionListView)
            {
