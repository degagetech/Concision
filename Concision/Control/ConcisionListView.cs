...
{
    public class ConcisionListView : ListView, IConcisionControl
    {
        [Browsable(false)]
        ...
        protected override void OnDrawItem(DrawListViewItemEventArgs e)
        {
            ...
            {
                //Draw text
                g.DrawString(subItem.Text, SkinManager.FontOfMedium10, SkinManager.GetPrimaryTextBrush(),
        ...
        protected override void OnCreateControl()
        {
            ...
            var skinFont = new Font(SkinManager.FontOfMedium12.FontFamily, 24);
            var skinFontLogfont = new LogFont();
            skinFont.ToLogFont(skinFontLogfont);
            ...
            try
            {
                ...
                Font = Font.FromLogFont(skinFontLogfont);
            }
