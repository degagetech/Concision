...
{
    public class ConcisionCheckBox : System.Windows.Forms.CheckBox, IConcisionControl
    {
        [Browsable(false)]
        ...
        {
            var w = _boxOffset + CHECKBOX_SIZE + 2 + (int)CreateGraphics().MeasureString(Text, SkinManager.FontOfMedium10).Width;
