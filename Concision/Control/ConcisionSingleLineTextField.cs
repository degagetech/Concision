...
{
    public class ConcisionSingleLineTextField : System.Windows.Forms.Control, IConcisionControl
    {
        ...
        public ConcisionSingleLineTextField()
        {
        ...
        private class BaseTextBox : TextBox
        {
            ...
            public BaseTextBox()
            {
                ConcisionContextMenuStrip cms = new TextBoxContextMenuStrip();
        ...
        private class TextBoxContextMenuStrip : ConcisionContextMenuStrip
        {
            public readonly ToolStripItem Undo = new ConcisionToolStripMenuItem { Text = "Undo" };
            public readonly ToolStripItem Seperator1 = new ToolStripSeparator();
            public readonly ToolStripItem Cut = new ConcisionToolStripMenuItem { Text = "Cut" };
            public readonly ToolStripItem Copy = new ConcisionToolStripMenuItem { Text = "Copy" };
            public readonly ToolStripItem Paste = new ConcisionToolStripMenuItem { Text = "Paste" };
            public readonly ToolStripItem Delete = new ConcisionToolStripMenuItem { Text = "Delete" };
            public readonly ToolStripItem Seperator2 = new ToolStripSeparator();
            public readonly ToolStripItem SelectAll = new ConcisionToolStripMenuItem { Text = "Select All" };
