...
{
    public class ConcisionRaisedButton : System.Windows.Forms.Button, IConcisionControl
    {
        [Browsable(false)]
        ...
        public override string Text
        {
            ...
            {
                base.Text = value;
                _textSize = CreateGraphics().MeasureString(value.ToUpper(), SkinManager.FontOfMedium10);
                if (AutoSize)
                    Size = GetPreferredSize();
                Invalidate();
            }
