...
{
    public class ConcisionContextMenuStrip : System.Windows.Forms.ContextMenuStrip, IConcisionControl
    {
        ...
        public ConcisionContextMenuStrip()
        {
            Renderer = new ConcisionToolStripRender();
    ...
    public class ConcisionToolStripMenuItem : System.Windows.Forms.ToolStripMenuItem
    {
        public ConcisionToolStripMenuItem()
        {
            AutoSize = false;
        ...
        protected override ToolStripDropDown CreateDefaultDropDown()
        {
            ...
            var defaultDropDown = new ConcisionContextMenuStrip();
    ...
    internal class ConcisionToolStripRender : System.Windows.Forms.ToolStripProfessionalRenderer, IConcisionControl
    {
        //Properties for managing the material design properties
        public int Depth { get; set; }
        public ConcisionManager SkinManager => ConcisionManager.Instance;
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            //Ripple animation
            var toolStrip = e.ToolStrip as ConcisionContextMenuStrip;
            if (toolStrip != null)
            {
