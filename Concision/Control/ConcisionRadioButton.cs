...
{
    public class ConcisionRadioButton : System.Windows.Forms.RadioButton, IConcisionControl
    {
        [Browsable(false)]
        ...
        {
            var width = _boxOffset + 20 + (int)CreateGraphics().MeasureString(Text, SkinManager.FontOfMedium10).Width;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            SizeF stringSize = g.MeasureString(Text, SkinManager.FontOfMedium10);
            g.DrawString(Text, SkinManager.FontOfMedium10, Enabled ? SkinManager.GetPrimaryTextBrush() : SkinManager.GetDisabledOrHintBrush(), _boxOffset + 22, Height / 2 - stringSize.Height / 2);
        ...
        protected override void OnCreateControl()
        {
            ...
            Font = SkinManager.FontOfMedium10;
