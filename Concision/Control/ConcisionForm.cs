...
{
    public class ConcisionForm : System.Windows.Forms.Form, IConcisionControl
    {
        [Browsable(false)]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //Form title
            g.DrawString(Text, SkinManager.FontOfMedium12, SkinManager.ColorScheme.TextBrush, new Rectangle(SkinManager.FORM_PADDING, STATUS_BAR_HEIGHT, Width, ACTION_BAR_HEIGHT), new StringFormat { LineAlignment = StringAlignment.Center });
        }
    }
